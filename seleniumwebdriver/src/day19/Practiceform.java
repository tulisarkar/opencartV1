...
public class Practiceform {
	...
	public static void main(String[] args) {
		...
		driver.get(" https://fs2.formsite.com/meherpavan/form2/index.html?1614085808963");
...
List<WebElement> checkboxes=driver.findElements(By.xpath("//input[@type='checkbox' and contains(@id,'RESULT_CheckBox-8')]"));
		...
		Select drpdn=new Select(driver.findElement(By.xpath("//select[@id='RESULT_RadioButton-9']")));
	drpdn.selectByVisibleText("Morning");
	driver.findElement(By.linkText("Software Testing Tutorials")).click();
	driver.findElement(By.xpath("//a[normalize-space()='Software Testing Tools Training']")).click();
